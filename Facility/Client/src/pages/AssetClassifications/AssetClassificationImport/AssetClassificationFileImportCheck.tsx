...
const AssetClassificationFileImportCheck: React.FC = () => {
  ...
  function backToClassification() {
    history("/asset-classifications");
      ...
      const checkFile = (e: any) => {
        ...
        const url: any =
          process.env.REACT_APP_API_ASSET + "classification/checkExcelFile";
...
export default AssetClassificationFileImportCheck;