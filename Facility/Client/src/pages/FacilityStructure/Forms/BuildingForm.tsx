...
const BuildingForm = ({
    ...
    const buildingStructures = ['Building-Floor-Block', 'Building-Block-Floor', 'Building-Floor'];
    ...
    const getNodeInfoForUpdate = (selectedNodeKey: string) => {
        FacilityStructureService.nodeInfo(selectedNodeKey)
            .then((res) => {
                ...
                setOperationStartDate(new Date(res.data.properties.OperationStartDate) || "");
                setWarrantyExpireDate(new Date(res.data.properties.WarrantyExpireDate) || "");
